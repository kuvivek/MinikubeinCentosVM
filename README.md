This is an excerpts from the following links:
...
Poweroff the Vmware Virtual Machine and in the VM settings, enable all the check boxes within the Virtualization Engine.


[kuvivek@vivekcentos k8sInstaller]$ sudo mv kubectl /usr/local/bin
...
[kuvivek@vivekcentos k8sInstaller]$ 
[kuvivek@vivekcentos k8sInstaller]$ kubectl config use-context minikube
